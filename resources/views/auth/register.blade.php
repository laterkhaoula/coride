<x-guest-layout>
 ...
 <h2 class="text-2xl font-bold text-slate-900">Inscription CoRide</h2>
 <p class="text-sm text-slate-600">Rejoignez la communauté de covoiturage de votre entreprise</p>
 </div>
 ...
 <select id="entreprise_id" name="entreprise_id" class="block mt-1 w-full border-slate-300 focus:border-blue-500 focus:ring-blue-500 rounded-md shadow-sm" required>
 ...
 <select id="role" name="role" class="block mt-1 w-full border-slate-300 focus:border-blue-500 focus:ring-blue-500 rounded-md shadow-sm" required>
