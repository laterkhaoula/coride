            ...
            <div class="p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-sm">
                ...
                <form method="POST" action="{{ route('employes.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <select id="entreprise_id" name="entreprise_id" class="block mt-1 w-full border-slate-300 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-300 rounded-md shadow-sm" required>
                    ...
                    <div>
                        ...
                        <select id="role" name="role" class="block mt-1 w-full border-slate-300 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-300 rounded-md shadow-sm" required>
                    ...
                    <div class="flex items-center justify-end gap-4 pt-4 border-t border-slate-100 dark:border-slate-800">
                        ...
                        <button type="submit" class="px-6 py-2.5 bg-indigo-600 text-white font-semibold text-sm rounded-xl shadow-md">
                            Enregistrer
                        </button>
                    </div>
                </form>
